package  utility
{
	...
	public class Camera
	{
		...
		public function adjustToPlayer(mapHeight:int, mapWidth:int, player:ThePlayer):void
		{			
		...
		public function followPlayer (mapHeight:Number, mapWidth:Number, player:ThePlayer):void
		{			
